...
/**
  ...
  fields (magic, size), reads and validates the mutable heap pointers,
  then delegates to SmemScanUncached().
...
/**
  ...
  Called from QualcommSmemInit() after the TOC page has been mapped.
