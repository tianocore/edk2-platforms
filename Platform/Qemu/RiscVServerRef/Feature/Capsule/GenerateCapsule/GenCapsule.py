...
def GenCapsuleDevice (BaseName, PayloadFileName, Guid, Version, Lsv, CapsulesPath, CapsulesSubDir):
    ...
    Log ('openssl, gcab must be install and in path')
...
if __name__ == '__main__':
    ...
    #
    CodeFW = os.path.join (EdkiiBuildOutput, 'FV', 'RISCV_SERVER_REF_CODE.fd')
    GenCapsuleDevice('RISCVSERREF', CodeFW, '8f7a3c21-6d9e-4b85-a2f1-c7e934d1e6ab', 0x00010000, 0x00000000, CapsulesPath, CapsulesSubDir)
