...
#define FVP_GT_BLOCK_FRAME0_GSIV_GICV5    (GICV5_INTERRUPT_TYPE_SPI | 0x19)
...
#define FVP_GT_BLOCK_FRAME1_GSIV_GICV5    (GICV5_GSI_TYPE_IWB | 0x3)
...
// GICv5
#define GICV5_INTERRUPT_TYPE_SHIFT            (29)
#define GICV5_INTERRUPT_TYPE_PPI              (1 << GICV5_INTERRUPT_TYPE_SHIFT)
#define GICV5_INTERRUPT_TYPE_LPI              (2 << GICV5_INTERRUPT_TYPE_SHIFT)
#define GICV5_INTERRUPT_TYPE_SPI              (3 << GICV5_INTERRUPT_TYPE_SHIFT)

#define GICV5_GSI_TYPE_IWB                    (7 << GICV5_INTERRUPT_TYPE_SHIFT)
...
#define FVP_GICV5_IWB_GSIV_BASE               (GICV5_GSI_TYPE_IWB)

#define FVP_GICV5_PMU_IRQ                     (GICV5_INTERRUPT_TYPE_PPI | 0x17)
#define FVP_GICV5_VGIC_IRQ                    (GICV5_INTERRUPT_TYPE_PPI | 0x19)

#define FVP_GICV5_ARM_ARCH_S_TIMER_IRQ        (GICV5_INTERRUPT_TYPE_PPI | 0x1d)
#define FVP_GICV5_ARM_ARCH_NS_TIMER_IRQ       (GICV5_INTERRUPT_TYPE_PPI | 0x1e)
#define FVP_GICV5_ARM_ARCH_VIRT_TIMER_IRQ     (GICV5_INTERRUPT_TYPE_PPI | 0x1b)
#define FVP_GICV5_ARM_ARCH_HYP_TIMER_IRQ      (GICV5_INTERRUPT_TYPE_PPI | 0x1a)

#define FVP_GICV5_SPCR_IRQ                    (GICV5_INTERRUPT_TYPE_SPI | 0x05)
#define FVP_GICV5_DBG_IRQ                     (GICV5_INTERRUPT_TYPE_SPI | 0x06)

#define FVP_GICV5_SMMU3_EVENT_IRQ             (GICV5_INTERRUPT_TYPE_SPI | 0x4a)
#define FVP_GICV5_SMMU3_PRI_IRQ               (GICV5_INTERRUPT_TYPE_SPI | 0x4b)
