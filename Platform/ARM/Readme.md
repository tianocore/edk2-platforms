...
```
> build -a AARCH64 -t GCC5 -p Platform\ARM\VExpressPkg\PlatformStandaloneMm.dsc -b < DEBUG | RELEASE > { -D option1, -D option2, ... }
```
...
```
%WORKSPACE%\Build\ArmVExpress-FVP-AArch64\<DEBUG|RELEASE>_GCC5\FV\BL32_AP_MM.fd
```
...
The FIP image should be generated with the following additional option:
```
...
./tools/fiptool/fiptool --verbose update \
   ...
   --tos-fw ${WORKSPACE}/Build/ArmVExpress-FVP-AArch64/DEBUG_GCC5/FV/BL32_AP_MM.fd \
   --nt-fw ${WORKSPACE}/Build/ArmVExpress-FVP-AArch64/DEBUG_GCC5/FV/FVP_AARCH64_EFI.fd \
