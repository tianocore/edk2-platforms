 ...
 */
typedef enum {
  FWS_IMAGE_UNACCEPT_REQ,       /// Set Image state as Unaccepted.
  FWS_IMAGE_ACCEPT_REQ,         /// Set Image state as Accepted
  FWS_IMAGE_WRITE_UNACCEPT_REQ, /// Set Image state as Unaccepted when starting write.
  FWS_ACCEPT_REQ_MAX,
} FWS_ACCEPT_REQ;
