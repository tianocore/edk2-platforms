  ...
  )
{
  ...
  if ((GptHandle == NULL) || (GptHandle->Instance == NULL)) {
    DEBUG ((DEBUG_ERROR, "GetGptPartitionInfo: Invalid parameters\n"));
  ...
  if (EFI_ERROR (Status)) {
    DEBUG ((DEBUG_ERROR, "GetGptPartitionInfo: Failed to read GPT partition info\n"));
  }
  ...
  )
{
  ...
  if ((GptHandle == NULL) || (GptHandle->Instance == NULL) || (DestBuffer == NULL)) {
  ...
  )
{
  ...
  if ((GptHandle == NULL) || (GptHandle->Instance == NULL) || (SrcBuffer == NULL)) {
  ...
  )
{
  ...
  Status = GetGptPartitionInfo (TmpGptHandle, &Header);
  if (EFI_ERROR (Status)) {
