/** @file
  ...
  Refer to the Hardware Description section of Morello's Technical
  Reference Manual
...
/**
 ...
 A valid PCI Segment address should not contain 1's in bits 28..31 and 48..63
  ...
  @param Mask Additional bits to assert to be zero.
**/
#define ASSERT_INVALID_PCI_SEGMENT_ADDRESS(Address, Mask) \
  ASSERT (((Address) & (0xffff0000f0000000ULL | (Mask))) == 0)
