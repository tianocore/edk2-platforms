...
#define AMD_SMBIOS_TYPE26_MAX_STRING_COUNT     5
...
typedef struct {
  ...
  PORT_CONNECTOR_STR    DesignatorStr;
...
//
// AMD SMBIOS type 26 record structure array.
//
typedef struct {
  SMBIOS_TABLE_TYPE26    VoltageProbe;
  // Support up to 5 strings
  CHAR8                  *String[AMD_SMBIOS_TYPE26_MAX_STRING_COUNT];
} SMBIOS_VOLTAGE_PROBE_INFO_RECORD;
