  ...
  )
{
 ...
 #ifdef RISCV_PEI_BOOTING
  SecStartup (TempRamSize, TempRamBase, (VOID *)(UINTN)PcdGet32 (PcdRiscVDxeMemFvBase));
 #else
  // Default PEIless booting
  SecPEIlessStartup (TempRamSize, TempRamBase, (VOID *)(UINTN)PcdGet32 (PcdRiscVDxeMemFvBase));
 #endif
