  ...
  )
{
  ...
  if ((FixedPcdGet64 (PcdSmemBaseAddress) != 0) && (FixedPcdGet64 (PcdSmemSize) != 0)) {
  ...
  if ((FixedPcdGet64 (PcdBootDtBase) != 0) && (FixedPcdGet64 (PcdBootDtSize) != 0)) {
...
{
  //
  // Only reserve the Trace32 DDR debug buffer when the platform configured it.
  //
