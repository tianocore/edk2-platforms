## @file
#  NordMinPlatformPkg.dsc
#
#  Description file for NordMinPlatformPkg
#
...
[PcdsFixedAtBuild]
  gMinPlatformPkgTokenSpaceGuid.PcdFlashAreaBaseAddress                   | 0xD8D00000
  ...
  gEfiMdeModulePkgTokenSpaceGuid.PcdSerialRegisterBase                    | 0x00884000
...
!include NordMinPlatformPkg/Include/Dsc/Stage1.dsc.inc
!include NordMinPlatformPkg/Include/Dsc/Stage2.dsc.inc
!include NordMinPlatformPkg/Include/Dsc/Stage3.dsc.inc
!include NordMinPlatformPkg/Include/Dsc/Stage4.dsc.inc
...
[PcdsFixedAtBuild]
  ...
  #
  gArmTokenSpaceGuid.PcdSystemMemoryBase                                  | 0xD8D00000
  ...
  #
  # Device Tree (DT)
  gQualcommMinPlatformPkgTokenSpaceGuid.PcdBootDtBase                        | 0xD9D00000
  gQualcommMinPlatformPkgTokenSpaceGuid.PcdBootDtSize                        | 0x00100000
  ...
  # Trace32 Debug
  gQualcommMinPlatformPkgTokenSpaceGuid.PcdTrace32DdrBase                    | 0xA8FFB000
  gQualcommMinPlatformPkgTokenSpaceGuid.PcdTrace32DdrSize                    | 0x00005000


[LibraryClasses.Common]
  BoardInitLib            | NordMinPlatformPkg/Library/BoardInitLib/BoardInitLib.inf
