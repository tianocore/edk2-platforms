## @file
#  The main build description file for the NordOpenBoardPkg (Qualcomm Nord Generic).
#
...
[Defines]
  ...
  PLATFORM_NAME               = NordOpenBoardPkg
  PLATFORM_VERSION            = 0.1
  SUPPORTED_ARCHITECTURES     = AARCH64
  FLASH_DEFINITION            = Platform/Qualcomm/NordOpenBoardPkg/NordOpenBoardPkg.fdf
  OUTPUT_DIRECTORY            = Build/NordOpenBoardPkg
...
[LibraryClasses.common]
  ...
  BoardInitLib|Platform/Qualcomm/NordOpenBoardPkg/Library/BoardInitLib/BoardInitLib.inf
...
!if $(USER_PROVIDED_DTB) == FALSE
  Platform/Qualcomm/NordOpenBoardPkg/DeviceTree/DummyDeviceTree.inf
!endif
