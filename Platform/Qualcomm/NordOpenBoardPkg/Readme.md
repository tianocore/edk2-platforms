# Qualcomm Nord Generic UEFI platform (NordOpenBoardPkg)
...
- `NordOpenBoardPkg.dsc` - MinPlatform staged DSC: sets `PcdBootStage`,
...
- `NordOpenBoardPkg.fdf` - multi-FV flash layout: sets the board flash sizes and
...
build -a AARCH64 -t GCC -p Platform/Qualcomm/NordOpenBoardPkg/NordOpenBoardPkg.dsc
```

The firmware device
`Build/NordOpenBoardPkg/<TARGET>_GCC/FV/NORDOPENBOARDPKG.fd` is loaded by
TF-A as BL33.
...
`Platform/Qualcomm/NordOpenBoardPkg/DeviceTree/nord-board.dtb` and build
